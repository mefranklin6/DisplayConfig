...
{
    [Cmdlet(VerbsLifecycle.Disable, "DisplayWCG")]
    public sealed class DisableDisplayWCGCommand : Cmdlet
    {
        ...
        {
            ColorInfo.ToggleAdvancedColor(this, DisplayId, enabled: false, ColorToggleKind.WCG);
        }
    }
}